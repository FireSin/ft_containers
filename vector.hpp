...
namespace ft{
	...
	public:
		...
		vector& operator=(const vector& other){
			...
			this->_mas = this->_alloc.allocate(this->_capacity);
		...
		~vector(){this->_alloc.destroy(this->_mas); this->_alloc.deallocate(this->_mas, this->_size);};
